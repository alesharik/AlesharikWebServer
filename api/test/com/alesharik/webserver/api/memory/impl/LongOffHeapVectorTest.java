...
public class LongOffHeapVectorTest {
    private static final long FIRST_VALUE = 5235554553445423435L;
    private static final long SECOND_VALUE = 845643254363412424L;
    private static final long THIRD_VALUE = 7642355762345325L;
    private static final long FOURTH_VALUE = 5235554553445423435L;
    private static final long DUDE = 1023475642352365L;
    private static final long NOT_EXISTS = 62344;

    private static final LongOffHeapVector array = new LongOffHeapVector();
    ...
    public void instanceTest() throws Exception {
        LongOffHeapVector v = LongOffHeapVector.instance();
    ...
    public void formCharArray() throws Exception {
        long[] arr = {FIRST_VALUE, SECOND_VALUE, THIRD_VALUE, FOURTH_VALUE};
        long addr = 0;
        try {
            addr = array.fromLongArray(arr);
    ...
    public void toCharArray() throws Exception {
        long[] arr = array.toLongArray(address);
    ...
    public void iteratorTest() throws Exception {
        Iterator<Long> iter = array.iterator(address);
