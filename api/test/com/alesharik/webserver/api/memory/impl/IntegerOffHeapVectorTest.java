...
public class IntegerOffHeapVectorTest {
    private static final int FIRST_VALUE = 523;
    private static final int SECOND_VALUE = 52453;
    private static final int THIRD_VALUE = 5652;
    private static final int FOURTH_VALUE = 523;
    private static final int DUDE = 10234;
    private static final int NOT_EXISTS = 45455;

    private static final IntegerOffHeapVector array = new IntegerOffHeapVector();
