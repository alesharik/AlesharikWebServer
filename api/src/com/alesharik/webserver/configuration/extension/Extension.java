...
public interface Extension {
    ...
    /**
     * Execute configuration. Will be invoked in extension's own thread
     */
    void start();

    /**
     * Reload the configuration. Will be invoked in extension's own thread
     *
    ...
    /**
     * Shutdown the extension. Will be invoked in extension's own thread
     */
    void shutdown();

    /**
     * Shutdown the extension now. Will be invoked in extension's own thread
     */
    void shutdownNow();
