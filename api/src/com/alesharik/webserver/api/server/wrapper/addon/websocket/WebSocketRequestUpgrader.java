...
public final class WebSocketRequestUpgrader implements Handler {
    ...
    private static final ListHeader<String> CONNECTION_HEADER = HeaderManager.getHeaderByName("Connection", ListHeader.class);
    private static final StringHeader UPGRADE_HEADER = HeaderManager.getHeaderByName("Upgrade", StringHeader.class);
    private static final IntHeader WS_VERSION_HEADER = HeaderManager.getHeaderByName("Sec-WebSocket-Version", IntHeader.class);
    private static final StringHeader WS_KEY_HEADER = HeaderManager.getHeaderByName("Sec-WebSocket-Key", StringHeader.class);
    private static final StringHeader WS_ACCEPT_HEADER = HeaderManager.getHeaderByName("Sec-WebSocket-Accept", StringHeader.class);
    ...
    public void handle(@Nonnull Request request, @Nonnull Response response) {
        int version = request.getHeader(WS_VERSION_HEADER, Integer.class);
        ...
        String key = request.getHeader(WS_KEY_HEADER, String.class);
    ...
    static String magic(String key) {
