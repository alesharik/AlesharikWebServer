...
import com.alesharik.webserver.api.server.wrapper.server.mx.HttpServerMXBean;
...
public interface HttpServer extends HttpServerMXBean {
    ...
    @Nonnull
    Set<ServerSocketWrapper> getServerSocketWrappers();

    @Nonnull
    Set<HttpHandlerBundle> getBundles();
