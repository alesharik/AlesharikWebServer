...
public class ASMUtils {
    ...
    public static boolean isStore(int opcode) {
        return opcode == AASTORE || opcode == ASTORE || opcode == BASTORE || opcode == CASTORE || opcode == DASTORE || opcode == SASTORE || opcode == LSTORE || opcode == LASTORE || opcode == ISTORE || opcode == IASTORE || opcode == FSTORE || opcode == FASTORE || opcode == DSTORE;
    }
    ...
    public static boolean isLoad(int opcode) {
        return opcode == SALOAD || opcode == LALOAD || opcode == IALOAD || opcode == FALOAD || opcode == DALOAD || opcode == CALOAD || opcode == BALOAD || opcode == AALOAD || opcode == LLOAD || opcode == ILOAD || opcode == FLOAD || opcode == DLOAD || opcode == ALOAD;
    }
}
