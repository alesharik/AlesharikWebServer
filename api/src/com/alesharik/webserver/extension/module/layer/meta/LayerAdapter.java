...
public interface LayerAdapter {
     ...
     * If {@link com.alesharik.webserver.extension.module.layer.Layer#autoInvoke()} is enabled, it automatically start all submodules and sublayers
     *
     ...
     * If {@link com.alesharik.webserver.extension.module.layer.Layer#autoInvoke()} is enabled, it automatically shut down all submodules and sublayers
     *
