 ...
 */
@ThreadSafe
public final class SessionStorage implements HttpProcessor {
    private final Storage.Factory factory;
    private final int storeTime;

    private final ConcurrentLiveHashMap<String, Storage> sessions = new ConcurrentLiveHashMap<>(1000L, 16, true, (s, storage) -> storage.cleanup());
    ...
    public void resetTimeout(String session) {
        sessions.resetTime(session);
    }
