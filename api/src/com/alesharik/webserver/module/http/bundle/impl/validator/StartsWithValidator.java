...
public final class StartsWithValidator implements Validator {
    @Nonnull
    private final String startsWith;

    @Override
    public boolean isRequestValid(@Nonnull Request request) {
        return request.getContextPath().startsWith(startsWith);
    }
}
