...
public class LoggingErrorHandler implements ErrorHandler {
    ...
    @Override
    public void handleException(Exception e, Request request, Response response, ErrorHandler.Pool pool) {
        System.err.println("Exception in pool " + pool.name() + " while processing request " + request);
