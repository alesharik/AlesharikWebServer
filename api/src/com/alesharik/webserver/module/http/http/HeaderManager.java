...
import com.alesharik.webserver.module.http.http.data.Host;
import com.alesharik.webserver.module.http.http.data.Range;
import com.alesharik.webserver.module.http.http.data.ReferrerPolicy;
import com.alesharik.webserver.module.http.http.data.TkType;
import com.alesharik.webserver.module.http.http.data.UserAgent;
import com.alesharik.webserver.module.http.http.data.Warning;
import com.alesharik.webserver.module.http.http.header.AcceptCharsetHeader;
import com.alesharik.webserver.module.http.http.header.AcceptEncodingHeader;
import com.alesharik.webserver.module.http.http.header.AcceptHeader;
import com.alesharik.webserver.module.http.http.header.AcceptLanguageHeader;
import com.alesharik.webserver.module.http.http.header.AcceptRangesHeader;
import com.alesharik.webserver.module.http.http.header.AuthenticateHeader;
import com.alesharik.webserver.module.http.http.header.AuthorizationHeader;
import com.alesharik.webserver.module.http.http.header.ConstantHeader;
import com.alesharik.webserver.module.http.http.header.CookieHeader;
import com.alesharik.webserver.module.http.http.header.IfETagHeader;
...
import com.alesharik.webserver.module.http.http.header.SetCookieHeader;
 ...
 * <td>{@link com.alesharik.webserver.module.http.http.data.Authentication}</td>
 * <td>WWW-Authenticate: Basic realm="Access to the staging site"</td>
 * </tr>
 * <tr>
 * <td>Authorization</td>
 * <td>{@link com.alesharik.webserver.module.http.http.data.Authorization}</td>
 ...
 * <tr>
 * <td>Accept</td>
 * <td>mime types({@link com.alesharik.webserver.module.http.http.data.WeightMimeType}[])</td>
 * <td>Accept: text/plain, application/xml;q=0.5, *;1=0.1</td>
 * </tr>
 * <tr>
 * <td>Accept-Charset</td>
 * <td>{@link com.alesharik.webserver.module.http.http.data.WeightCharset}[]</td>
 * <td>Accept-Charset: utf-8, iso-8859-1;q=0.5, *;q=0.1</td>
 * </tr>
 * <tr>
 * <td>Accept-Encoding</td>
 * <td>{@link com.alesharik.webserver.module.http.http.data.WeightEncoding}[]</td>
 * <td>Accept-Encoding: br, gzip;q=0.8, *;q=0.1</td>
 * </tr>
 * <tr>
 * <td>Accept-Language</td>
 * <td>{@link com.alesharik.webserver.module.http.http.data.WeightLocale}[]</td>
 ...
 * <tr>
 * <td>Cookie</td>
 * <td>{@link com.alesharik.webserver.module.http.http.data.Cookie}[]</td>
 ...
 * <tr>
 * <td>Accept-Ranges</td>
 * <td>{@link com.alesharik.webserver.module.http.http.header.AcceptRangesHeader.RangeType}</td>
...
public class HeaderManager {
    ...
    static {
        ...
        //Downloads
        headers.put("Content-Disposition", new ObjectHeader<>("Content-Disposition", new ContentDispositionFactory()));
    ...
    public static <T extends Header> T getHeaderByName(String name) {
    ...
    private static final class ContentDispositionFactory implements ObjectHeader.Factory<ContentDisposition> {

        @Override
        public ContentDisposition newInstance(String s) {
            return ContentDisposition.parse(s);
        }

        @Override
        public String toString(ContentDisposition contentDisposition) {
            return contentDisposition.toHeaderString();
        }
    }
}
