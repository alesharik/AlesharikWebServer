...
public class ConcurrentLiveHashMapTest {
    private ConcurrentLiveHashMap<Integer, Integer> map;

    @Before
    public void setUp() {
        map = new ConcurrentLiveHashMap<>();
        map.stop();
    }
    ...
    public void putAllFromMapWithPeriodSupplier() {
        ...
        for(int i = 0; i < 100; i++) {
            assertEquals(i, map.get(i).intValue());
            assertEquals(1, map.getPeriod(i));
        }
    }
    ...
    public void entrySetIterator() {
        ...
        for(int i = 0; i < 100; i++) {
            ...
            assertEquals(i, next.getKey().intValue());
            assertEquals(i, next.getValue().intValue());
        }
    ...
    public void cloneTest() {
        ...
        ConcurrentLiveHashMap<Integer, Integer> mapa = map.clone();
        for(int i = 0; i < 100; i++)
