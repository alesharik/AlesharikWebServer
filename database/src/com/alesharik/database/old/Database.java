...
package com.alesharik.database.old;

import com.alesharik.database.old.exception.DatabaseConnectionFailedException;
import com.alesharik.database.old.exception.DatabaseExecutionException;
import com.alesharik.database.old.proxy.TransactionProxyFactory;
import com.alesharik.database.old.transaction.TransactionManager;
import com.alesharik.database.old.transaction.TransactionManagerImpl;
import com.alesharik.database.old.transaction.reflect.TransactionCallable;
import com.alesharik.database.old.transaction.reflect.TransactionRunnable;
...
public class Database {
    ...
    public <V> RefTable<V> createRefTable(String name, Class<V> value, boolean isForeign, String ref) {
        return dbDriver.createRefTable(name, value, isForeign, ref);
    }
    ...
    private static final class Test {
        ...
        private static final void m(Test t) {
