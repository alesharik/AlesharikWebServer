...
import com.alesharik.database.old.entity.Column;
import com.alesharik.database.old.entity.Ignore;
import com.alesharik.database.old.entity.RefTableProvider;
import com.alesharik.database.old.entity.ReferenceTable;
...
public final class EntityManager {
    ...
    private static final class Entity {
        ...
        private static final class EntityField {
            ...
            private final boolean hasRefTable;
            ...
            public EntityField(Field field, Column annotation) {
                ...
                this.hasRefTable = field.isAnnotationPresent(ReferenceTable.class);
                this.referenceTable = field.getAnnotation(ReferenceTable.class);
            }

            public String getColumnType(TypeTranslator typeTranslator) {
                if(hasRefTable && field.getType().isArray()) {
                    return name + ' ' + " uuid REFERENCES " + name + "_ref_table";
                } else
            ...
            public RefTable createRefTable(RefTableProvider provider) {
                if(hasRefTable) {
                    return provider.createRefTable(name, field.getType(), referenceTable.foreignKey(), referenceTable.refTable());
                }
                return null;
            }
